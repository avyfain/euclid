    ...
    <main className="cover-page">
      ...
      <section className="cover-hero" aria-labelledby="cover-title">
        <div className="cover-introduction">
          ...
          <h1 id="cover-title" aria-label="See how geometry builds up.">
            <span className="cover-title-line">See how</span>
            <span className="cover-title-line">geometry</span>
            <span className="cover-title-line">builds up.</span>
          </h1>
